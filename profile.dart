...
StreamBuilder(
      ...
      Row( 
        ...
        Icon(Icons.verified, color: Color(0xFF941701), size: 21,),
        ],
);  
       } 
      ...
      Row( 
        ...
        Icon(Icons.verified, color: Color(0xFF918989), size: 21,),
        ],
);  
       } 
             else 
  ...
  StreamBuilder(
      ...
      Row( 
        children: <Widget>[
           ...
           SizedBox(width: 6,), 
        Text('Current rating : $rat1\/5', style: kOnBoardingHeadingStyle3,),
        ],
);
...
if(result2["noofhelps"] >= 5)
{
            Fluttertoast.showToast(
        msg: 'Thank you for helping so many people solve their problems. YOU ARE AWESOME!',
