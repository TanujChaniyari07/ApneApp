...
class CallPage1 extends StatefulWidget {
  ...
  const CallPage1({Key key, this.channelName, this.role, this.idd}) : super(key: key);

  @override
  _CallPageState1 createState() => _CallPageState1();
}
class _CallPageState1 extends State<CallPage1> {
  bool _finished;
   ...
   Widget _panel() {
    ...
    StreamBuilder(
      ...
      builder: (context, AsyncSnapshot<DocumentSnapshot> snapshot) {
       ...
       var userDocument = snapshot.data;
        int noh2 = userDocument["Helper NOH"];
        String nam = userDocument["Helper Name"];
        double rat = userDocument["Helper Rating"];
      ...
      Row( 
        ...
        Text('Finding helper...', style: kOnBoardingSubHeadingStyle,),
        ],
);

      } 
            else if(nam == "Not Chosen..."){
        return 
      Row( 
        children: <Widget>[
           SizedBox(width: 6,),  
        
        Text('Not Chosen...', style: kOnBoardingSubHeadingStyle,),
        ],
);
      ...
      Row( 
        ...
        Text('Helper Disconnected', style: kOnBoardingSubHeadingStyle,),
        ],
);
      ...
      Row( 
        children: <Widget>[
           ...
           SizedBox(width: 6,),  
        Text('Helper : $nam', style: kOnBoardingSubHeadingStyle,
    ...
    Row( 
        children: <Widget>[
           ...
           SizedBox(width: 10,),  
        Text('Rating : $rat', style: kOnBoardingSubHeadingStyle,
...
SizedBox(width: 10,), 
    Row( 
        children: <Widget>[
           ...
           Icon(Icons.star, color: Colors.white,),
           SizedBox(width: 6,),  
        Text('Rating : $rat1\/5', style: kOnBoardingSubHeadingStyle,
