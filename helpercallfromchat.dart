...
class CallPagehelper extends StatefulWidget {
  ...
  const CallPagehelper({Key key, this.channelName, this.role}) : super(key: key);

  @override
  _CallPageStatehelper createState() => _CallPageStatehelper();
}
class _CallPageStatehelper extends State<CallPagehelper> {
  bool _finished;
